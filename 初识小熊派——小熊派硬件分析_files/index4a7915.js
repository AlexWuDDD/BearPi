...
if(""!==n("mockcps"))var j="/mp/cps_product_info?biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&cpslist="+f+"&sn="+window.sn+"&mockcps="+n("mockcps");else var j="/mp/cps_product_info?biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&cpslist="+f+"&sn="+window.sn+"&istempurl="+(window.is_temp_url||0)+"&random="+A;
!function(e,i,n){
_({
url:i,
type:"GET",
...
!function(e,o){
if(b.on(e,"tap",".js_product_loop_content",function(e){
try{
...
e>=40&&!P?(P=!0,window.show_top_bar&&window.user_name&&window.topbarEnable?(A.invoke("currentMpInfoShow",function(){}),
_({
...
dataType:"json",
async:!0
})):document.title=window.title):40>e&&P&&(P=!1,window.show_top_bar&&window.user_name&&window.topbarEnable?(A.invoke("currentMpInfoHide",function(){}),
_({
url:"/mp/appmsgreport?action=topbarevent",
data:{
__biz:biz,
...
source_logo_url:"",
is_ad:1
},V=u.attr(W[H],"data-templateid");
"list"==V?W[H].innerHTML=s.tmpl(c,U):"banner"==V?W[H].innerHTML=s.tmpl(d,U):"card"==V&&(W[H].innerHTML=s.tmpl(p,U));
}
}catch(F){
console.log(F);
}
var Q,J=null;
o(),b.on(window,"scroll",o),a(),b.on(window,"scroll",O),A.on("topbar:click",function(){
_({
url:"/mp/appmsgreport?action=topbarevent",
data:{
__biz:biz,
...
},function(){}),A.invoke("createWebViewForFastLoad",{
scene:1
},function(e){
console.log(e);
...
A.invoke("downloadPageDataForFastLoad",{
itemList:[{
...
e.offsetTop<n?(t=!0,b.off(window,"scroll",i),(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=59977_15_1",
I.hotspotReport({
...
var j=y.item(A),I=j.getAttribute("href")||"";
...
var y=v.gtVersion("6.5.13",!0)&&o.isGif(),b=v.gtVersion("6.8.0",!0)&&o.canHevc();
return M&&(y||b)&&(window.__addIdKeyReport("28307",106),o=et.addParam(o,"tp","wxpic",!0),
...
-1!=navigator.userAgent.indexOf("WindowsWechat")?location.href=t:A.invoke("profile",{
username:source_username,
scene:e.scene+""
});
}else{
...
v.isInMiniProgram||(1==isprofileblock?A.invoke("openUrlWithExtraWebview",{
...
if(mt){
var lt="";
b.on(mt,"click",function(){
return w.hasClass(mt,"rich_media_meta_link")?window.is_temp_url?(i("Unable to do this in preview"),
...
}),h(),y(),b.tap(document.getElementById("js_hotspot_area"),function(e){
...
-1!=navigator.userAgent.indexOf("MicroMessenger")&&(v.isIOS||v.isAndroid||v.isWp)?A.invoke("openUrlWithExtraWebview",{
url:t,
openType:1
},function(e){
...
var ht=Math.random();
if(2e-4>ht)try{
for(var vt=document.getElementsByTagName("img"),yt=window.screen.height,bt=window.screen.width,At=0,jt=window.devicePixelRatio,At="",H=0,It=vt.length;It>H;H++){
var xt=vt[H].getAttribute("data-src");
if(xt){
var Et=vt[H].getBoundingClientRect();
At+=bt+"|"+yt+"|"+Et.left.toFixed(2)+"|"+(bt-Et.right).toFixed(2)+"|"+Et.width.toFixed(2)+"|"+jt.toFixed(2)+"|"+xt+";";
}
}
_({
