...
var u,l=i.songlist[0],d=l.song_play_url,y=l.song_play_time||0;
...
function d(){
Et.mylist.children.length?(m(Et.mylist.parentNode),Nt||Y.removeClass(document.body,zt)):(a(Et.mylist.parentNode),
Nt||Y.addClass(document.body,zt));
}
function s(e){
Et.el_alertContent.innerHTML=e,Et.el_alertPanel.style.display="";
}
function l(){
Nt?(Y.removeClass(document.getElementById("js_success_panel_pc"),"weui-transition_opacity-hide"),
setTimeout(function(){
...
e.top<$.getInnerHeight()&&vt&&t&&((new Image).src="/mp/jsmonitor?idkey=28307_45_1&lc=1&log0",
...
function g(){
var e=Et.showAll,t=$.getScrollTop(),n=ct.getY(e,"js_article");
return 0===e.clientHeight?!1:(e.clientHeight+n>=t+e.clientHeight/2&&e.clientHeight+n<=t+e.clientHeight/2+$.getInnerHeight()&&(lt.report(18832,_extends({
Actiontype:1,
Type:3,
Bizuin:0,
Msgid:0,
...
e.innerHTML=Yt.encode(e.innerHTML);
});
}
function w(e,t,n){
var o=void 0,i=void 0,m="",a="",d=document.createElement("div");
"elected"===n?a=0:"friend"===n&&(a=1),Ht={};
for(var s=0;s<e.length;s++){
if(i=e[s],i.time=f(i.create_time),i.status="",i.logo_url=i.logo_url||Wt,i.logo_url=-1!==i.logo_url.indexOf("wx.qlogo.cn")?i.logo_url.replace(/\/132$/,"/96"):i.logo_url,
...
i.new_appmsg=window.new_appmsg,m+=it.tmpl(W,i);
try{
...
for(d.innerHTML=m,y(d);d.children.item(0);)o=d.children.item(0),t.appendChild(o);
}
function h(e){
var t=void 0,n=void 0,o=Date.now(),i=e.resp,d=e.loadTime,s=e.forceRefresh,l=document.createDocumentFragment(),c=document.createDocumentFragment();
if(yt=i.only_fans_can_comment,_(_t.handleList,encodeURIComponent(JSON.stringify({
comment_id:ht,
offset:jt,
url:Rt
}))),1!==i.enabled?(qt&&(qt.style.display="none"),Ft&&a(Ft),i.elected_comment=[],
i.friend_comment=[],i.elected_comment_total_cnt=0,i.friend_comment_total_cnt=0):(qt&&(qt.style.display="block"),
Ft&&m(Ft)),0===jt){
...
wt=!0,Math.random()<.1&&(G.saveSpeeds({
uin:window.uin,
pid:675,
speeds:[{
sid:27,
...
}else a(Et.main),!yt||yt&&1===i.is_fans?Nt?(m(Et.commentPC),m(Et.inputPC)):m(Et.addCmtBtn2):m(document.getElementById("js_cmt_nofans2"),"block");
n=i.friend_comment,w(n,c,"friend"),n&&0===n.length&&a(Ft),s&&(Et.fdlist.innerHTML=""),
Et.fdlist.appendChild(c),n&&n.length?(m(Et.fdmain),(!yt||yt&&1===i.is_fans)&&(Nt||(a(Et.addCmtBtn1),
a(Et.addCmtBtn2),m(Et.addCmtBtn3)))):a(Et.fdmain);
...
0===i.elected_comment_total_cnt?(jt=-1,a(document.getElementById("js_cmt_loading")),
a(document.getElementById("js_cmt_statement")),a(document.getElementById("js_cmt_qa"))):jt+Lt>=i.elected_comment_total_cnt?(jt=-1,
...
var y=0;
m(Et.showAll),a(document.getElementById("js_cmt_statement"));
...
Et.listContainer.style.height=y+"px",Et.showAllWording.innerText="View %s more comment(s)".replace("%s",t.length-f),
...
t=t===!0,t&&(jt=0);
var o=$.getScrollTop(),i=document.documentElement.scrollHeight;
if(!(vt||-1===jt||jt>0&&i-o-$.getInnerHeight()>500)){
...
var d=X.join("/mp/appmsg_comment",{
action:"getcomment",
scene:_t.scene,
appmsgid:window.appmsgid,
idx:window.idx,
...
vt=!0,a(Et.tips),m(Et.loading);
try{
It++,t&&(kt=[]),It>1&&!t&&_(_t.moreList,encodeURIComponent(d)),kt.indexOf(d)>-1&&_(_t.repeatList,encodeURIComponent(d)),
kt.push(d);
}catch(l){
console.error(l);
}
Ut&&console.info("[图文评论] 开始请求评论数据:",d),at("[Appmsg comment] start get comment data, url:"+d),
ot({
url:d,
dataType:"json",
success:function(e){
...
forceRefresh:t,
loadTime:Date.now()-s
}):_(_t.errList,"type:resperr;url:"+encodeURIComponent(d)+";ret="+o),at("[Appmsg comment] get comment success");
},
error:function(){
_(_t.errList,"type:ajaxerr;url:"+encodeURIComponent(d)),at("[Appmsg comment] get comment ajax error");
},
complete:function(){
vt=!1,a(Et.loading),nt.off(window,"scroll",u);
}
});
}
}
...
function C(){
Et.list.children.length?Et.fdlist.children.length?(m(Et.addCmtBtn3),a(Et.addCmtBtn1),
a(Et.addCmtBtn2),a(Et.addCmtBtn4)):(m(Et.addCmtBtn1),a(Et.addCmtBtn2),a(Et.addCmtBtn3),
a(Et.addCmtBtn4)):Et.fdlist.children.length?(m(Et.addCmtBtn3),a(Et.addCmtBtn4),a(Et.addCmtBtn1),
a(Et.addCmtBtn2)):(m(Et.addCmtBtn2),a(Et.addCmtBtn3),a(Et.addCmtBtn1),a(Et.addCmtBtn4)),
Nt&&(a(Et.addCmtBtn1),a(Et.addCmtBtn2),a(Et.addCmtBtn3));
}
function v(e,t){
...
}],n,"mine"),Et.mylist.insertBefore(n,Et.mylist.firstChild),d(),Nt?(Et.input.innerHTML="",
Et.inputHolder.style.display=""):Et.input.value="",C();
}
function b(){
st.log("tag1");
var e=void 0,t=X.join("/mp/appmsg_comment",{
action:"addcomment",
scene:_t.scene,
appmsgid:window.appmsgid,
idx:window.idx,
...
!Y.hasClass(Et.submit,"btn_disabled")&&Et.submit.disabled!==!0){
if(st.log("tag3"),e.length<1)return void s("Comment cannot be blank");
if(st.log("tag4"),e.length>600)return void s("600 characters max");
Nt&&(e=xt),st.log("tag5"),Nt?Et.submit.disabled=!0:Y.addClass(Et.submit,"btn_disabled"),
st.log("tag6");
...
dataType:"json",
success:function(n){
switch(st.log("tag8"),Nt||Yt.hidePannel(),+n.ret){
case 0:
v(n,e);
break;

case-6:
s("You're commenting too frequently. Take a break and try again later.");
break;

case-7:
s("You have not followed this Official Account yet. Unable to comment.");
break;

case-10:
s("600 characters max");
break;

case-15:
s("Comments have been disabled");
break;

default:
gt=e,s("System error. Try again later.");
}
...
complete:function(){
""!==Et.input.value&&Y.removeClass(Et.submit,"btn_disabled");
}
});
}
}
...
function I(){
var e=document.getElementById("js_mycmt_loading"),t=X.join("/mp/appmsg_comment",{
action:"getmycomment",
scene:_t.scene,
appmsgid:window.appmsgid,
idx:window.idx,
...
function k(e){
Ct=$.getScrollTop(),a(Et.article),m(Et.mine),Et.deletePanel=document.getElementById("js_delete_panel_mobile"),
...
window.__second_open__&&Q.os.ios&&m(Et.fakebar),window.scrollTo(0,0),I(),e||st.later(function(){
Et.input.focus();
});
}
function E(){
"1"===X.getQuery("js_my_comment")&&k(!0);
}
function T(){
...
function x(){
a(Et.mine),m(Et.article),Et.deletePanel=document.getElementById("js_delete_panel"),
Et.deleteConfirm=document.getElementById("js_delete_confirm"),Et.deleteCancel=document.getElementById("js_delete_cancel"),
window.scrollTo(0,Ct),Et.input.blur(),Y.removeClass(document.body,St),Y.removeClass(document.body,zt),
$.isNativePage()||"5"!==window.item_show_type||(Z.invoke("setNavigationBarColor",{
color:"#1f1f1f"
...
function M(e){
var t=Y.hasClass(e,"praised"),n=e.querySelector(".praise_num"),o=n.innerHTML,i=o.indexOf("0K"),m=parseInt(o,10)?parseInt(o,10):0;
t?(-1===i&&(n.innerHTML=m-1>0?m-1:""),Y.removeClass(e,"praised"),e.dataset.status=0):(-1===i&&(n.innerHTML=m+1),
Y.addClass(e,"praised"),e.dataset.status=1);
}
function D(e){
var t=e.delegatedTarget||e.srcElement,n=null;
if(Y.hasClass(t,"js_comment_praise")&&(n=t),n){
for(var o=parseInt(n.dataset.status,10),i=0===o?1:0,m=n.dataset.contentId,a=n.dataset.scene,d=document.querySelectorAll('.js_comment_praise[data-content-id="'+m+'"]'),s=0;s<d.length;s++)M(d[s]);
J({
...
function H(e){
for(var t=e.delegatedTarget,n=parseInt(t.dataset.status,10),o=n?0:1,i=t.dataset.contentId,m=t.dataset.replyId,a=t.dataset.scene,d=document.querySelectorAll('.js_reply_praise[data-content-id="'+i+'"]'),s=0;s<d.length;s++)M(d[s]);
ot({
...
function P(e,t){
e.parentNode.removeChild(e),Y.addClass(Et.deletePanel,"weui-transition_opacity-hide");
for(var n=document.querySelectorAll(".cid"+t),o=0;o<n.length;o++)n[o].parentNode.removeChild(n[o]);
Et.list.children.length?Et.fdlist.children.length||a(Et.fdmain):(a(Et.main),a(document.getElementById("js_cmt_statement")),
a(document.getElementById("js_cmt_qa")),Et.fdlist.children.length||a(Et.fdmain)),
d(),C();
}
function L(e){
var t=void 0,n=e.delegatedTarget,i=n.getAttribute("data-my-id"),m=X.join("/mp/appmsg_comment",{
action:"delete",
scene:_t.scene,
appmsgid:window.appmsgid,
my_id:i,
...
Y.removeClass(Et.deletePanel,"weui-transition_opacity-hide"),nt.on(Et.deleteConfirm,"click",function(){
t!==i&&(t=i,ot({
url:m,
dataType:"json",
success:function(e){
...
t!==i&&(t=i,Y.addClass(Et.deletePanel,"weui-transition_opacity-hide"));
});
}
function R(e){
e&&e.preventDefault(),x(),a(Et.fakebar);
}
function N(e,t){
if(!T()){
if($.isNativePage()||"5"!==window.item_show_type||(Y.addClass(document.body,St),
Z.invoke("setNavigationBarColor",{
color:"#191919"
}),Z.invoke("setBounceBackground",{
backgroundColor:"#191919"
})),t)return Ut&&console.log("FakeHash on comment"),void k();
e.preventDefault(),window.__second_open__&&Q.os.ios?k():(Ut&&console.log("push comment"),
mt.push("comment"));
}
}
function S(e){
...
n.length<1?Y.addClass(Et.submit,"btn_disabled"):Y.removeClass(Et.submit,"btn_disabled"),
Q.os.ios&&e.data&&Gt.indexOf(e.data)>-1&&(Bt=!0);
}),nt.on(Et.input,"click",function(){
Q.os.ios&&Bt&&(Et.input.blur(),Et.input.focus(),Bt=!1);
...
nt.on(Et.mylist,"click",".js_del",L),nt.on(Et.fdlist,"click",".js_del",L),$.listenMpPageAction(function(e){
...
e.preventDefault();
}),Et.goback&&(nt.on(Et.goback,"click",R),nt.on(Et.goback,"click",R)),window.__second_open__&&Q.os.ios&&!function(){
nt.on(Et.input,"click",function(){
a(Et.fakebar);
...
Et.mine.style.height=$.getInnerHeight()+"px",window.scrollBy&&window.scrollBy(0,1),
...
a(Et.inputPC),m(Et.containerPC),z(Et.containerPC)&&S(Et.containerPC),Et.input.focus();
}),nt.bindVisibilityChangeEvt(function(e){
e&&$.getScrollTop()<V.getOffset(Et.cmtContainer).offsetTop-$.getInnerHeight()&&j({
forceRefresh:!0,
cb:h
});
}),nt.on(Et.showAllWording,"tap",function(e){
e.preventDefault(),a(Et.showAll),m(document.getElementById("js_cmt_statement")),
...
w.innerText=e,e>600?(y.style.display="",Y.addClass(y,"comment_primary_counter_warn"),
Et.submit.disabled=!0):1>e?(y.style.display="none",Y.removeClass(y,"comment_primary_counter_warn"),
Et.submit.disabled=!0):(y.style.display="none",Y.removeClass(y,"comment_primary_counter_warn"),
...
var i=n.createContextualFragment(e),m=i.lastChild,a=et.getSelection();
...
var u=void 0,g=et.getRange(),f=Yt.edata,y=document.getElementById("js_length_notice_pc"),w=document.getElementById("js_word_length_pc");
...
""===c(o)&&(a(Et.containerPC),m(Et.inputPC),a(n));
}
p(t,n)||p(t,Et.emotionSwitchPC)||"none"===n.style.display||a(n);
...
Ft.innerHTML=it.tmpl(m,{
new_appmsg:window.new_appmsg
});
}
var a=document.createElement("div");
a.innerHTML=it.tmpl(dt,{
new_appmsg:window.new_appmsg,
isIos:Q.os.ios
}),document.body.appendChild(a),Nt?(i("js_cmt_mine"),document.getElementById("js_avatar_pc").src=bt,
Y.addClass(document.body,"pages_skin_pc")):i("js_cmt_addbtn_pc"),Et={
...
},window.__second_open__&&Q.os.ios&&(Et.mine.style.marginBottom=getComputedStyle(Et.fakebar).height),
!t.notAutoGetComment&&j({
forceRefresh:!0,
cb:h
}),E(),Nt&&I(),Yt.init(),q(),Nt&&F();
}
function U(){
A();
}
e("biz_common/utils/string/html.js");
var Y=e("biz_common/dom/class.js"),W=e("appmsg/cmt_tpl.html.js"),G=e("biz_common/utils/wxgspeedsdk.js"),K=e("appmsg/comment_report.js"),Q=e("biz_wap/utils/device.js"),J=e("appmsg/retry_ajax.js"),V=e("biz_common/dom/offset.js"),X=e("biz_common/utils/url/parse.js"),Z=e("biz_wap/jsapi/core.js"),$=e("common/utils.js"),et=e("appmsg/emotion/selection.js"),tt=e("appmsg/i18n.js"),nt=e("biz_common/dom/event.js"),ot=e("biz_wap/utils/ajax.js"),it=e("biz_common/tmpl.js"),mt=e("biz_wap/utils/fakehash.js"),at=e("appmsg/log.js"),dt=e("appmsg/my_comment_tpl.html.js"),st=e("appmsg/emotion/dom.js"),lt=e("common/comm_report.js"),ct=e("biz_wap/utils/position.js"),rt={
...
repeatContent:24,
repeatContentID:23
},pt=void 0,ut=void 0,gt=void 0,ft=void 0,yt=void 0,wt=void 0,ht=0,jt=0,Ct=void 0,vt=!1,bt="",Bt=!1,It=0,kt=[],Et={},Tt=[],xt="",Mt="Me",Dt=0,Ht={},Pt=Date.now(),Lt=100,Rt=location.href,Nt=Q.os.pc,St="comment_editing",zt="my_comment_empty_data",At=navigator.userAgent.indexOf("MicroMessenger")>-1,qt=document.getElementById("js_cmt_area"),Ft=document.getElementById("js_friend_cmt_area"),Ot=document.getElementById("js_cmt_container"),Ut=Rt.indexOf("vconsole=1")>0||document.cookie&&document.cookie.indexOf("vconsole_open=1")>-1,Yt=e(Nt?"appmsg/emotion/emotion_pc.js":"appmsg/emotion/emotion.js"),Wt="http://mmbiz.qpic.cn/mmbiz/ByCS3p9sHiak6fjSeA7cianwo25C0CIt5ib8nAcZjW7QT1ZEmUo4r5iazzAKhuQibEXOReDGmXzj8rNg/0",Gt=["“”","‘’","（）","《》","〈〉","「」","『』","〔〕","【】","［］","[]","｛｝","{}","()","<>"];
...
At||(qt&&(qt.style.display="none"),Ft&&(Ft.style.display="none"),ht=0),Ut&&console.info("[图文评论] 评论ID:",ht),
U(),{
initComment:O,
getCommentData:j,
renderComment:h
...
return e&&e.length>maxLikeCommentWord?void alert2("想法不可以超过%s字".replace("%s",maxLikeCommentWord)):void alert2("Network unavailable. Try again later.");
}
...
i=-1===t?o+"0K":o.substr(0,t)+"."+o.charAt(t+1)+"0K";
